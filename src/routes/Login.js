...
export default class Login extends Component {
    ...
    async goLogin(){
        ...
        if(username===''){Toast.offline('请输入您的账号!',2);this.chgDisabled(false);return;}
        if(password===''){Toast.offline('请输入您的密码!',2);this.chgDisabled(false);return;}
            ...
            <div className={styles.rootBox}>
                ...
                <div className={styles.main}>
                    ...
                    <List className={styles.inputList}>
                        <InputItem type='number' maxLength='11' placeholder='请输入帐号' ref={el=>this.username=el} />
                        <InputItem type='password' placeholder='请输入密码' onExtraClick={()=>history.push('/chgpwd')} extra='忘记密码' ref={el=>this.password=el} />
                    </List>
